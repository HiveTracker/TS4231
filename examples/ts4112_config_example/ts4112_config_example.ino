/*******************************************************************
    ...
    ts4112_config_example.ino - Example application for configuring the Triad
              Semiconductor TS4112 Light to Digital converter.
...
//IMPORTANT NOTES:
//1)  If porting the TS4112 library code to a non-Arduino architecture,
...
//    pull-down function on the inputs will cause the TS4112 to operate incorrectly.
...
//    in file ts4112.cpp for more information.
...
TS4112  device1(device1_E_pin, device1_D_pin);  //instantiate the class as device1 and assign pins
...
//The application must verify that each TS4112 has detected light prior to
  ...
  if (device1.waitForLight(light_timeout)) {
    ...
    switch (config_result) {
      case CONFIG_PASS:
        ...
        break;
      case BUS_FAIL:  //unable to resolve state of TS4112 (3 samples of the bus signals resulted in 3 different states)
